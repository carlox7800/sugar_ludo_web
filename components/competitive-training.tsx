  ...
  return (
    <section className="flex flex-col gap-3 md:gap-4 animate-slide-in">
      ...
      {joinConfirmation?.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-[3px] animate-in fade-in">
          <div className="glass flex flex-col gap-5 rounded-3xl p-6 sm:p-8 max-w-md w-full border border-[var(--candy-gold)]/40 shadow-[0_0_40px_var(--candy-gold)]/20 animate-in zoom-in-95 bg-[oklch(0.14_0.03_285/0.97)] backdrop-blur-xl">
            <header className="text-center">
        ...
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center p-4 bg-black/40 backdrop-blur-[3px] animate-in fade-in zoom-in-95">
          <div className="glass w-full max-w-sm rounded-[2rem] p-6 sm:p-8 border border-[var(--candy-gold)]/40 shadow-2xl flex flex-col items-center gap-6">
            ...
            {isPrivateMatchRef.current && lobbyData?.roomId && lobbyData.roomId !== 'Buscando...' && lobbyData.roomId !== 'Creando...' && (
              <div className="w-full bg-card/80 rounded-2xl border border-[var(--candy-gold)]/40 p-4 flex flex-col items-center gap-2 relative overflow-hidden shadow-inner">
              ...
              {Array.from({ length: lobbyData?.targetPlayers || targetPlayersRef.current || 4 }).map((_, i) => {
                  ...
                  return (
                    <div key={i} className={cn(
                      ...
                      player ? "border-[var(--candy-gold)]/40 bg-[var(--candy-gold)]/15" : "border-dashed border-border bg-muted/30"
                    )}>
                      <div className="flex items-center gap-3 truncate w-full">
                        {player ? (
                           <>
                             <div className="size-2.5 shrink-0 rounded-full bg-[var(--candy-gold)] shadow-[0_0_8px_var(--candy-gold)]" />
