...
export function TopBar({ onSettingsOpen, onStoreOpen }: { onSettingsOpen: () => void; onStoreOpen?: () => void }) {
  ...
  return (
    <header className="sticky top-[max(1rem,env(safe-area-inset-top,0px))] z-50 glass flex w-full items-center justify-between rounded-[2rem] border border-border/30 bg-[oklch(1_0_0/0.03)] p-2 pl-4 pr-3 shadow-[inset_0_1px_5px_oklch(1_0_0/0.05)]">
