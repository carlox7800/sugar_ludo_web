...
export const HexGameView: React.FC<HexGameViewProps> = ({
  ...
  return (
    <div className="w-full flex-1 flex flex-col items-center text-white relative overflow-hidden">
      ...
      {notification && (
        <div className="fixed top-12 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-top-2 flex items-center justify-center gap-2 rounded-2xl border border-[var(--candy-cyan)]/50 bg-[#0f172a]/95 sm:backdrop-blur-md px-6 py-3 text-[var(--candy-cyan)] font-display text-sm font-extrabold shadow-lg pointer-events-none">
      ...
      <div className="relative w-full flex-1 flex flex-col items-center justify-center min-h-[600px] z-10">
        ...
        {gameState.logs.length > 0 && (
          <div className="fixed bottom-7 md:bottom-8 left-1/2 transform -translate-x-1/2 z-50 pointer-events-none w-auto max-w-[90vw] sm:max-w-md text-center px-2 transition-all duration-300">
            <span className="inline-block bg-[#0f172a]/95 sm:backdrop-blur-md border border-[var(--candy-cyan)]/40 px-4 py-1.5 sm:px-5 sm:py-2 rounded-full text-white text-xs sm:text-sm font-extrabold tracking-wide shadow-[0_4px_20px_rgba(0,0,0,0.7)] truncate max-w-full">
