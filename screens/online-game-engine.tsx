...
export function OnlineGameEngine({ 
  ...
  return (
    <div className="h-[100dvh] md:h-auto md:min-h-screen w-full flex flex-col font-sans cyber-bg text-foreground relative overflow-hidden items-center pb-safe">
